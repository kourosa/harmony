        ...
        return (
            <div>
                <div className="sidebar">
                    <a className="active" href="/">гармония</a>
                    <a href="#p" onClick={() => { this.setState({ menuState: "coupons" }) }}>Coupons </a>
                    <a href="#d" onClick={() => { this.setState({ menuState: "messages" }) }}>Messages </a>
                    <a onClick={this.handleSignout} href="#Update">Sign Out</a>
                </div>
                            ...
                            <div className="pcard">
                                ...
                                <div className="container" id="guide">
                                    <div className="grouplist">
                                        ...
                                        {this.state.coupons.length ? null : "You dont have any cerificate"}
                                    </div>
